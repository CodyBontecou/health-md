...
| Export formats | [JSON export](./json-export.md) | Schema-v6 summaries plus the authoritative `healthmd.healthkit_records` v1 source archive. | Drafted | High | `JSONExporter`, `HealthKitRecordArchiveSerializer` |
...
| Export formats | [Export schema contract](./export-schema.md) | Define schema v6, canonical record completeness, ownership, migration, and parser guidance. | Drafted | High | `HealthMdExportSchema`, `HealthKitRecordArchive`, `ExportSchemaSignatureTests` |
...
| Mac destination | [iPhone → Mac destination](./mac-sync.md) | Write iPhone-prepared v6 exports to Mac through encrypted, bounded, checksum-validated transfer. | Drafted | High | `SyncService.swift`, `ConnectedTransfer.swift` |
