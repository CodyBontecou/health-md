...
- Valid App Store Connect products:
  - Individual Monthly: `com.codybontecou.obsidianhealth.pro.monthly`
  - Individual Yearly: `com.codybontecou.obsidianhealth.pro.yearly`
  - Individual Lifetime: `com.codybontecou.obsidianhealth.unlock`
  - Family Monthly: `com.codybontecou.obsidianhealth.pro.family.monthly` with Family Sharing enabled
  - Family Yearly: `com.codybontecou.obsidianhealth.pro.family.yearly` with Family Sharing enabled
...
3. Choose an Individual or Family monthly, yearly, or lifetime plan.
4. Confirm the purchase or subscription with Apple.
...
- **Hook:** “Health.md lets you test exports first, then unlock unlimited exports with the plan that fits your workflow.”
- **Demo flow:**
  1. Show the free exports remaining label on Export.
  2. Use the final free export.
  3. Trigger the paywall.
  4. Explain unlimited exports, scheduled exports, future features, subscriptions, and lifetime options.
...
- `PurchaseManager.monthlyProductID` is the Individual Monthly product `com.codybontecou.obsidianhealth.pro.monthly`.
- `PurchaseManager.yearlyProductID` is the Individual Yearly product `com.codybontecou.obsidianhealth.pro.yearly`.
- `PurchaseManager.productID` is the Individual Lifetime product `com.codybontecou.obsidianhealth.unlock`.
- `PurchaseManager.familyMonthlyProductID` is the Family Monthly product `com.codybontecou.obsidianhealth.pro.family.monthly`.
- `PurchaseManager.familyYearlyProductID` is the Family Yearly product `com.codybontecou.obsidianhealth.pro.family.yearly`.
...
- `PaywallView` presents Individual and Family subscription/lifetime StoreKit purchase options plus restore, and dismisses when `isUnlocked` becomes true.
