...
import com.healthmd.domain.onboarding.OnboardingStep as ProductOnboardingStep
...
class OnboardingAnalyticsClient @Inject constructor(
    ...
    private fun ProductOnboardingStep.toAnalyticsStep(): OnboardingAnalyticsStep = when (this) {
        ProductOnboardingStep.WELCOME -> OnboardingAnalyticsStep.WELCOME
        ProductOnboardingStep.HEALTH_ACCESS -> OnboardingAnalyticsStep.HEALTH_ACCESS
        ProductOnboardingStep.FOLDER_SETUP -> OnboardingAnalyticsStep.FOLDER_SETUP
        ProductOnboardingStep.ACCESS -> OnboardingAnalyticsStep.UNLOCK
        ProductOnboardingStep.READY -> OnboardingAnalyticsStep.READY
    }
