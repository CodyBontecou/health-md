...
class ReleaseReadinessTest {
    ...
    fun googlePlayRelease_isPhoneOnlyWhileWearPublicationIsDeferred() {
        ...
        assertTrue(releaseWorkflow.contains(".release-tooling/apps/android/scripts/upload-google-play-phone-release.sh"))
        assertTrue(releaseWorkflow.contains("PLAY_ACCESS_TOKEN"))
        assertTrue(releaseWorkflow.contains("GOOGLE_PLAY_WORKLOAD_IDENTITY_PROVIDER"))
        assertTrue(!releaseWorkflow.contains("PLAY_CONSOLE_KEY_JSON"))
