...
- **Cross-origin exfiltration:** relative API constants, restrictive `connect-src 'self'`, no CORS, no remote assets, and a governed source/test/document/config/workflow/build scanner with fail-closed unexpected-binary handling.
