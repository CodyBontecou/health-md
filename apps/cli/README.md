...
never deletes stored revisions. The same read-only contract is available from an S3-compatible
(Cloudflare R2) bucket prefix laid out like an export directory:
