...
synchronized corpus or server-side health-data fallback. Local pairing and filesystem exports remain
in `healthmd-cli`. See the repository's [Remote MCP architecture](https://github.com/CodyBontecou/health-md/blob/main/apps/cli/docs/remote-mcp.md).
