...
enum HealthMetricExportMapping {
    // BEGIN GENERATED SHARED RUST EXPORT MAPPING
    ...
    static let metricIdToFrontmatterKeys: [String: [String]] = [
        ...
        "vo2_max": ["vo2_max", "vo2_max_source_uuid", "vo2_max_source_start", "vo2_max_source_end", "vo2_max_carried_forward", "vo2_max_age_seconds"],
        ...
        "medications": ["medication_count", "active_medication_count", "archived_medication_count", "medication_details", "medication_dose_count", "medication_dose_events", "medication_taken_count", "medication_skipped_count", "medications"],
        ...
        "workouts": ["workout_count", "workout_minutes", "workout_calories", "workout_distance_km", "workout_distance_mi", "workouts", "workout_avg_heart_rate", "workout_max_heart_rate", "workout_min_heart_rate", "workout_running_cadence", "workout_running_stride_length", "workout_running_ground_contact", "workout_running_vertical_oscillation", "workout_cycling_cadence", "workout_avg_power", "workout_max_power"],
    ]
    // END GENERATED SHARED RUST EXPORT MAPPING
