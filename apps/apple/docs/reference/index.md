...
- [API and CLI](./api-and-cli.md): API Endpoint envelopes, local control/query routes, CLI, strict raw results, and exit behavior.
...
- [`generated/rollups/`](./generated/rollups/): production range-v9 JSON/CSV/Markdown/Bases output, historical weekly-v8 examples, and the complete aggregation matrix.
