...
Obsidian Bases export writes schema-v8 Apple Health summaries and unambiguous typed-provider scalars as frontmatter-only Markdown. The body stays empty so each date behaves like a clean database row. Workout presentation fields can include zones, laps, splits, sample/route counts, and metadata.
...
The complete production-generated frontmatter is [`docs/reference/generated/core/lossless-day-bases.md`](../reference/generated/core/lossless-day-bases.md). Typed WHOOP projections are shown in [`docs/reference/generated/core/provider-day-bases.md`](../reference/generated/core/provider-day-bases.md); repeated records are intentionally not flattened.
