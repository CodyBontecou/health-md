...
| `$.records[].healthkit_record_archive.schema` | string |
| `$.records[].healthkit_record_archive.schema_version` | integer |
| `$.records[].providers` | object |
| `$.records[].providers.whoop` | object |
| `$.records[].providers.whoop.body` | object |
| `$.records[].providers.whoop.body.height_meters` | number |
| `$.records[].providers.whoop.body.max_heart_rate_bpm` | integer |
| `$.records[].providers.whoop.body.observed_at` | string |
| `$.records[].providers.whoop.body.source_kind` | string |
| `$.records[].providers.whoop.body.weight_kilograms` | number |
| `$.records[].providers.whoop.capture_status` | string |
| `$.records[].providers.whoop.cycles` | array |
| `$.records[].providers.whoop.cycles[]` | object |
| `$.records[].providers.whoop.cycles[].average_heart_rate_bpm` | integer |
| `$.records[].providers.whoop.cycles[].end_time` | string |
| `$.records[].providers.whoop.cycles[].energy_kilojoules` | integer |
| `$.records[].providers.whoop.cycles[].id` | string |
...
| `$.records[].providers.whoop.recoveries` | array |
| `$.records[].providers.whoop.recoveries[]` | object |
| `$.records[].providers.whoop.recoveries[].cycle_id` | string |
| `$.records[].providers.whoop.recoveries[].hrv_rmssd_ms` | number |
| `$.records[].providers.whoop.recoveries[].recovery_score_percent` | integer |
| `$.records[].providers.whoop.recoveries[].resting_heart_rate_bpm` | integer |
| `$.records[].providers.whoop.recoveries[].score_state` | string |
| `$.records[].providers.whoop.recoveries[].skin_temperature_celsius` | number |
| `$.records[].providers.whoop.recoveries[].sleep_id` | string |
| `$.records[].providers.whoop.recoveries[].spo2_percent` | number |
| `$.records[].providers.whoop.recoveries[].user_calibrating` | boolean |
| `$.records[].providers.whoop.resources` | array |
| `$.records[].providers.whoop.resources[]` | object |
| `$.records[].providers.whoop.resources[].record_count` | integer |
| `$.records[].providers.whoop.resources[].resource` | string |
| `$.records[].providers.whoop.resources[].status` | string |
| `$.records[].providers.whoop.schema` | string |
| `$.records[].providers.whoop.schema_version` | integer |
| `$.records[].providers.whoop.sleep` | array |
| `$.records[].providers.whoop.sleep[]` | object |
| `$.records[].providers.whoop.sleep[].awake_milliseconds` | integer |
| `$.records[].providers.whoop.sleep[].baseline_sleep_need_milliseconds` | integer |
| `$.records[].providers.whoop.sleep[].cycle_id` | string |
| `$.records[].providers.whoop.sleep[].disturbance_count` | integer |
| `$.records[].providers.whoop.sleep[].end_time` | string |
| `$.records[].providers.whoop.sleep[].id` | string |
| `$.records[].providers.whoop.sleep[].is_nap` | boolean |
| `$.records[].providers.whoop.sleep[].light_sleep_milliseconds` | integer |
| `$.records[].providers.whoop.sleep[].no_data_milliseconds` | integer |
| `$.records[].providers.whoop.sleep[].recent_nap_adjustment_milliseconds` | integer |
| `$.records[].providers.whoop.sleep[].recent_strain_need_milliseconds` | integer |
| `$.records[].providers.whoop.sleep[].rem_sleep_milliseconds` | integer |
| `$.records[].providers.whoop.sleep[].respiratory_rate_breaths_per_minute` | number |
| `$.records[].providers.whoop.sleep[].score_state` | string |
| `$.records[].providers.whoop.sleep[].sleep_consistency_percent` | integer |
| `$.records[].providers.whoop.sleep[].sleep_cycle_count` | integer |
| `$.records[].providers.whoop.sleep[].sleep_debt_need_milliseconds` | integer |
| `$.records[].providers.whoop.sleep[].sleep_efficiency_percent` | integer |
| `$.records[].providers.whoop.sleep[].sleep_performance_percent` | integer |
| `$.records[].providers.whoop.sleep[].slow_wave_sleep_milliseconds` | integer |
| `$.records[].providers.whoop.sleep[].start_time` | string |
| `$.records[].providers.whoop.sleep[].timezone_offset` | string |
| `$.records[].providers.whoop.sleep[].total_in_bed_milliseconds` | integer |
| `$.records[].providers.whoop.sleep[].total_sleep_milliseconds` | integer |
| `$.records[].providers.whoop.warnings` | array |
| `$.records[].providers.whoop.workouts` | array |
| `$.records[].providers.whoop.workouts[]` | object |
| `$.records[].providers.whoop.workouts[].altitude_change_meters` | integer |
| `$.records[].providers.whoop.workouts[].altitude_gain_meters` | integer |
| `$.records[].providers.whoop.workouts[].average_heart_rate_bpm` | integer |
| `$.records[].providers.whoop.workouts[].distance_meters` | integer |
| `$.records[].providers.whoop.workouts[].end_time` | string |
| `$.records[].providers.whoop.workouts[].energy_kilojoules` | integer |
| `$.records[].providers.whoop.workouts[].id` | string |
| `$.records[].providers.whoop.workouts[].max_heart_rate_bpm` | integer |
| `$.records[].providers.whoop.workouts[].percent_recorded` | number |
| `$.records[].providers.whoop.workouts[].score_state` | string |
| `$.records[].providers.whoop.workouts[].sport_name` | string |
| `$.records[].providers.whoop.workouts[].start_time` | string |
| `$.records[].providers.whoop.workouts[].strain_score` | number |
| `$.records[].providers.whoop.workouts[].timezone_offset` | string |
| `$.records[].providers.whoop.workouts[].zone_durations` | object |
| `$.records[].providers.whoop.workouts[].zone_durations.zone_five_milliseconds` | integer |
| `$.records[].providers.whoop.workouts[].zone_durations.zone_four_milliseconds` | integer |
| `$.records[].providers.whoop.workouts[].zone_durations.zone_one_milliseconds` | integer |
| `$.records[].providers.whoop.workouts[].zone_durations.zone_three_milliseconds` | integer |
| `$.records[].providers.whoop.workouts[].zone_durations.zone_two_milliseconds` | integer |
| `$.records[].providers.whoop.workouts[].zone_durations.zone_zero_milliseconds` | integer |
| `$.records[].raw_capture_status` | string |
| `$.records[].schema` | string |
| `$.records[].schema_version` | integer |
| `$.records[].time_context` | object |
