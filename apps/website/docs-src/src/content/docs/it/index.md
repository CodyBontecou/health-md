...
<div><strong>v7</strong><span>schema pubblico di esportazione</span></div>
...
<div class="related">
  ...
  <a href="/it/docs/cli-direct/"><span>Anteprima · CLI multipiattaforma</span>Accesso diretto all’iPhone — comprendi l’abbinamento tramite IP manuale o Tailscale prima del rilascio del pacchetto autonomo.</a>
  <a href="/it/docs/cli-extract/"><span>Dati di origine</span>Estrazione canonica — acquisisci giorni selezionati dello schema v7, record di origine, proiezioni o JSONL.</a>
...
<div class="related">
  ...
  <a href="/it/docs/reference/daily-records/"><span>Schema v7</span>Record giornalieri — comprendi il documento di origine pubblico e le relative regole di titolarità.</a>
...
<div class="related">
  ...
  <a href="/it/docs/scheduling/"><span>In background</span>Programmazione — comprendi il comportamento dell’esportazione programmata giornaliera e settimanale e i limiti della piattaforma.</a>
...
<p style="margin-top:48px; color:var(--sl-color-gray-3); font-size:12px; font-family:var(--sl-font-mono);">Struttura della documentazione aggiornata il 2026-08-02</p>
