...
description: "7개의 App Intent로 Siri, 단축어 앱, 집중 모드 필터, 자동화 및 AppIntent 지원 호스트에서 내보내기를 실행하고, 요약을 가져오고, 예약을 켜거나 끌 수 있습니다."
---
...
<a id="profiles"></a>
## 내보내기 프로필
<p>Health.md의 iPhone 또는 Android 앱에서 저장된 내보내기 프로필을 만들고 관리할 수 있습니다. Apple 플랫폼의 프로필 관리는 현재 iPhone에 대해서만 문서화되어 있으며, iPad 또는 macOS에서의 사용 가능 여부는 주장하지 않습니다.</p>
<p>네 개의 내보내기 인텐트 모두 선택적 <em>프로필</em> 매개변수를 받습니다. 프로필이 있으면 비워 둘 때 활성 프로필을 사용하고, 프로필이 없는 레거시 모드에서는 앱의 현재 내보내기 설정을 사용합니다. 저장된 프로필 이름을 전달하면 앱이 현재 표시하는 것과 관계없이 해당 프로필의 동결된 구성(지표 선택, 형식, 대상)으로 실행됩니다.</p>
<div class="callout">
