...
test('published agent assets are byte-exact and checksum-backed', async () => {
  ...
  const skillV5 = await read('docs-src/public/agents/skills/healthmd-cli/v5/SKILL.md');
  const skillV6 = await read('docs-src/public/agents/skills/healthmd-cli/v6/SKILL.md');
  const publishedSkill = await read('docs-src/public/agents/skills/healthmd-cli/v7/SKILL.md');
  ...
  assert.equal(sha256(skillV5), 'bb96f4f7416a1cf59b1229b9947be1eb407b790cce2cdd806b2bf054c1c17e04');
  assert.equal(sha256(skillV6), 'f1f6340ba0dafeee4f3c549b186a78cca1ee6676b4c219d2252bfa2d6a064515');
  ...
  assert.equal(skillManifest.latest.version, 7);
  assert.equal(skillManifest.latest.path, '/agents/skills/healthmd-cli/v7/SKILL.md');
  ...
  assert.equal(skillManifest.versions.length, 7);
  ...
  assert.equal(skillManifest.versions[4].sha256, sha256(skillV5));
  assert.equal(skillManifest.versions[5].sha256, sha256(skillV6));
