...
export const docsSidebar = Object.freeze([
  ...
  Object.freeze({
    ...
    items: Object.freeze([
      ...
      item(text('Google Drive export · Planned', 'Exportación a Google Drive · Planificada', 'Google-Drive-Export · Geplant', 'Export Google Drive · Planifié', 'Exportação para Google Drive · Planejada', 'Esportazione su Google Drive · Pianificata', 'Export naar Google Drive · Gepland', 'Google Driveエクスポート・計画中', 'Google Drive 내보내기 · 예정', 'Google Drive 导出 · 计划中'), 'guides/google-drive-export'),
