...
export const docsSidebar = Object.freeze([
  ...
  Object.freeze({
    labels: text('CLI', 'CLI', 'CLI', 'CLI', 'CLI', 'CLI', 'CLI', 'CLI', 'CLI', 'CLI'),
    collapsed: true,
    items: Object.freeze([
      ...
      item(text('Command reference', 'Referencia de comandos', 'Befehlsreferenz', 'Référence des commandes', 'Referência de comandos', 'Riferimento comandi', 'Opdrachtnaslag', 'コマンドリファレンス', '명령어 참고', '命令参考'), 'cli-reference'),
      item(text('healthmd status', 'healthmd status', 'healthmd status', 'healthmd status', 'healthmd status', 'healthmd status', 'healthmd status', 'healthmd status', 'healthmd status', 'healthmd status'), 'cli-reference/status'),
      item(text('healthmd export', 'healthmd export', 'healthmd export', 'healthmd export', 'healthmd export', 'healthmd export', 'healthmd export', 'healthmd export', 'healthmd export', 'healthmd export'), 'cli-reference/export'),
      item(text('healthmd extract', 'healthmd extract', 'healthmd extract', 'healthmd extract', 'healthmd extract', 'healthmd extract', 'healthmd extract', 'healthmd extract', 'healthmd extract', 'healthmd extract'), 'cli-reference/extract'),
      item(text('healthmd query', 'healthmd query', 'healthmd query', 'healthmd query', 'healthmd query', 'healthmd query', 'healthmd query', 'healthmd query', 'healthmd query', 'healthmd query'), 'cli-reference/query'),
      item(text('healthmd resume', 'healthmd resume', 'healthmd resume', 'healthmd resume', 'healthmd resume', 'healthmd resume', 'healthmd resume', 'healthmd resume', 'healthmd resume', 'healthmd resume'), 'cli-reference/resume'),
      item(text('healthmd cancel', 'healthmd cancel', 'healthmd cancel', 'healthmd cancel', 'healthmd cancel', 'healthmd cancel', 'healthmd cancel', 'healthmd cancel', 'healthmd cancel', 'healthmd cancel'), 'cli-reference/cancel'),
      item(text('healthmd direct', 'healthmd direct', 'healthmd direct', 'healthmd direct', 'healthmd direct', 'healthmd direct', 'healthmd direct', 'healthmd direct', 'healthmd direct', 'healthmd direct'), 'cli-reference/direct'),
      item(text('healthmd mcp', 'healthmd mcp', 'healthmd mcp', 'healthmd mcp', 'healthmd mcp', 'healthmd mcp', 'healthmd mcp', 'healthmd mcp', 'healthmd mcp', 'healthmd mcp'), 'cli-reference/mcp'),
      item(text('healthmd setup', 'healthmd setup', 'healthmd setup', 'healthmd setup', 'healthmd setup', 'healthmd setup', 'healthmd setup', 'healthmd setup', 'healthmd setup', 'healthmd setup'), 'cli-reference/setup'),
    ]),
  }),
  Object.freeze({
  ...
  Object.freeze({
    ...
    items: Object.freeze([
      ...
      item(text('Export profiles', 'Perfiles de exportación', 'Exportprofile', 'Profils d’exportation', 'Perfis de exportação', 'Profili di esportazione', 'Exportprofielen', 'エクスポートプロファイル', '내보내기 프로필', '导出配置文件'), 'export-profiles'),
