...
V3 is an additive, capability-gated iPhone query extension over v1 pairing, encrypted transport,
and framing. It does not replace v1 exports, introduce a pairing selector, or apply to Android.
...
- Swift v1/v3: [`apps/apple/Packages/HealthMdConnectivity/Sources/HealthMdConnectionCore`](../../../apps/apple/Packages/HealthMdConnectivity/Sources/HealthMdConnectionCore)
- Rust v1/v2/v3: [`packages/healthmd-core-rust/crates/healthmd-protocol`](../../healthmd-core-rust/crates/healthmd-protocol)
...
Apple/Android pairing selectors stay at 1/2, Apple exports stay at application version 1, Android
application stays at version 2, the capability-gated Apple query extension uses version 3, shared
