...
1 exposes deployed v1/v2 constants, strict canonical request fingerprints, complete Apple-v1
`DirectMessage` and Android-v2 `Envelope` canonicalization, `HMDDIRCT` transfer-frame
...
selectors remain Apple 1 and Android 2, Apple application remains 1, Android application remains 2,
and shared secure/binary framing remains 1. The canonical contract fixtures and crate mirrors are
